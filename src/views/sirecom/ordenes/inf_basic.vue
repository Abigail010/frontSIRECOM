                  ...
                  <v-col cols="12" md="10" sm="12">
                    ...
                    <v-card elevation="10" class="card-hover">
                        <v-card-item class="text-center">
                            <h4 class="text-h5 mt-3"> <img src="@/assets/images/misimagenes/logo_dipremin.png" style="width: 60%; height: auto;" class="position-relative d-none d-lg-flex" alt="login-home" /></h4>
