...
<template>
        ...
        <perfect-scrollbar style="height: calc(100vh - 90px)">
            <div class="pa-6">
                <h6 class="text-h6 mb-2">Barra de menú</h6>
                ...
                <v-btn-toggle v-model="customizer.setRTLLayout" color="primary" class="my-2 btn-group-custom gap-3" rounded="0" group>
                    <v-btn :value="false" variant="text"  elevation="9" class="rounded-md" >
                        <TextDirectionLtrIcon stroke-width="1.5" size="21"  class="icon" /> LTR
                    </v-btn>
                    <v-btn :value="true" variant="text" elevation="9" class="rounded-md">
                        <TextDirectionRtlIcon stroke-width="1.5" size="21" class="icon" /> RTL
                    </v-btn>
                </v-btn-toggle> -->

                <h6 class="text-h6 mt-8 mb-5">Color de interfaz claro</h6>
                ...
                <h6 class="text-h6 mt-11 mb-2">Opción del contenedor</h6>
